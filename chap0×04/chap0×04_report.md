...
### 任务一
  ```
    ...
    -h				帮助文档
    The command "bash tasks/5-1.sh -h" exited with 0.
    0.10s$ bash tasks/5-1.sh -q 80 ./img
    ./img/true.jpg is compressed into ./img/true_quality.jpg
    ./img/cuc.jpg is compressed into ./img/cuc_quality.jpg
    The command "bash tasks/5-1.sh -q 80 ./img" exited with 0.
    0.22s$ bash tasks/5-1.sh -r 50 ./img
    ./img/lena256.png is compressed into ./img/lena256_50%.png
    ./img/true.jpg is compressed into ./img/true_50%.jpg
    ./img/true_quality.jpg is compressed into ./img/true_quality_50%.jpg
    ./img/cuc_quality.jpg is compressed into ./img/cuc_quality_50%.jpg
    ./img/cuc.jpg is compressed into ./img/cuc_50%.jpg
    ./img/Zelda24.png is compressed into ./img/Zelda24_50%.png
    The command "bash tasks/5-1.sh -r 50 ./img" exited with 0.
    0.94s$ bash tasks/5-1.sh -w a_watermark ./img
    ./img/lena256.png is added watermark into ./img/lena256_watermarked.png
    ./img/true_quality_50%.jpg is added watermark into ./img/true_quality_50%_watermarked.jpg
    ./img/cuc_quality_50%.jpg is added watermark into ./img/cuc_quality_50%_watermarked.jpg
    ./img/true.jpg is added watermark into ./img/true_watermarked.jpg
    ./img/true_quality.jpg is added watermark into ./img/true_quality_watermarked.jpg
    ./img/cuc_quality.jpg is added watermark into ./img/cuc_quality_watermarked.jpg
    ./img/cuc.jpg is added watermark into ./img/cuc_watermarked.jpg
    ...
    ./img/true_50%.jpg is added watermark into ./img/true_50%_watermarked.jpg
    ./img/cuc_50%.jpg is added watermark into ./img/cuc_50%_watermarked.jpg
    The command "bash tasks/5-1.sh -w a_watermark ./img" exited with 0.
    0.03s$ bash tasks/5-1.sh -p a_head ./img
    prefix ia added
    prefix ia added
    prefix ia added
    prefix ia added
    ...
    prefix ia added
    prefix ia added
    The command "bash tasks/5-1.sh -p a_head ./img" exited with 0.
    0.03s$ bash tasks/5-1.sh -s a_tail ./img
    suffix is added
    suffix is added
    suffix is added
    suffix is added
    ...
    suffix is added
    suffix is added
    The command "bash tasks/5-1.sh -s a_tail ./img" exited with 0.
    0.14s$ bash tasks/5-1.sh -c ./img
    ...
    tranfer to jpg finished
    tranfer to jpg finished
    The command "bash tasks/5-1.sh -c ./img" exited with 0.
  ```
...
```
  ...
  -h          查看帮助信息
  The command "bash tasks/5-2.sh -h" exited with 0.
  1.10s$ bash tasks/5-2.sh -a
  20岁以下的球员有 9 个，占比： 1.223%
  20-30岁的球员有 600 个，占比：81.522%
  30岁以上的球员有127 个，占比： 17.255%
  The command "bash tasks/5-2.sh -a" exited with 0.
  0.02s$ bash tasks/5-2.sh -b
  ...
  The command "bash tasks/5-2.sh -b" exited with 0.
  0.02s$ bash tasks/5-2.sh -c
  名字最长的球员是：
  ...
  名字最短的球员是：
  Jô
  The command "bash tasks/5-2.sh -c" exited with 0.
  0.02s$ bash tasks/5-2.sh -d
  最小年龄是18,年龄最小的队员是:
  Fabrice Olinga
  Luke Shaw
  最大年龄是42,年龄最大的队员是:
  Faryd Mondragon
  The command "bash tasks/5-2.sh -d" exited with 0.
  0.00s$ bash tasks/5-3.sh -h
  usage:[options][]
  options:
  ...
  -h          查看帮助信息
  The command "bash tasks/5-3.sh -h" exited with 0.
  1.42s$ bash tasks/5-3.sh -a
  show_top100_host
  ...
  The command "bash tasks/5-3.sh -a" exited with 0.
  1.98s$ bash tasks/5-3.sh -b
  show_top_100_ip
  ...
  ip:163.205.3.38                  	324	
  ip:163.205.2.35                  	324	
  The command "bash tasks/5-3.sh -b" exited with 0.
  2.52s$ bash tasks/5-3.sh -c
  show_top100_url
  ...
  The command "bash tasks/5-3.sh -c" exited with 0.
  2.48s$ bash tasks/5-3.sh -d
  show_status_code
  ...
  The command "bash tasks/5-3.sh -d" exited with 0.
  4.82s$ bash tasks/5-3.sh -e
  403 top10:
  ...
  The command "bash tasks/5-3.sh -e" exited with 0.
  2.50s$ bash tasks/5-3.sh -u /images/USA-logosmall.gif
  show_url
  ...
  The command "bash tasks/5-3.sh -u /images/USA-logosmall.gif" exited with 0.
```

### shellcheck 检查脚本后的输出结果
```
$ /usr/bin/shellcheck tasks/5-1.sh
In tasks/5-1.sh line 22:
	jpeg_files=($(find "${dir}" -regex '.*\.jpg'))
                    ^-- SC2207: Prefer mapfile or read -a to split command output (or quote to avoid splitting).
In tasks/5-1.sh line 27:
...
Did you mean: 
		echo "$jpeg_file" 'is compressed into' "$file_name"'_quality.'"$file_tail"  
In tasks/5-1.sh line 37:
	jps_files=($(find "${dir}" -regex '.*\.jpg\|.*\.svg\|.*\.png'))
                   ^-- SC2207: Prefer mapfile or read -a to split command output (or quote to avoid splitting).
In tasks/5-1.sh line 43:
...
Did you mean: 
		echo "${jps_file}" 'is compressed into' "$file_name"'_'"$percent"'%.'"$file_tail"  
In tasks/5-1.sh line 54:
	all_files=($(find "${dir}" -regex '.*\.jpg\|.*\.svg\|.*\.png\|.*\.jpeg'))
                   ^-- SC2207: Prefer mapfile or read -a to split command output (or quote to avoid splitting).
In tasks/5-1.sh line 59:
...
Did you mean: 
	echo "${all_file}" 'is added watermark into' "$file_name"'_watermarked.'"$file_tail"
In tasks/5-1.sh line 69:
	files=($(find "${dir}" -regex '.*\.jpg\|.*\.svg\|.*\.png\|.*\.jpeg'))
               ^-- SC2207: Prefer mapfile or read -a to split command output (or quote to avoid splitting).
In tasks/5-1.sh line 76:
...
Did you mean: 
		mv "$file" "$file_dir"'/'"$prefix""$file_sname"'.'"$file_tail"
In tasks/5-1.sh line 86:
	files=($(find "${dir}" -regex '.*\.jpg\|.*\.svg\|.*\.png\|.*\.jpeg'))
               ^-- SC2207: Prefer mapfile or read -a to split command output (or quote to avoid splitting).
In tasks/5-1.sh line 91:
...
Did you mean: 
		mv "$file" "$file_name""$suffix"'.'"$file_tail"
In tasks/5-1.sh line 100:
	files=($(find "$dir" -regex  '.*\.png\|.*svg'))
               ^-- SC2207: Prefer mapfile or read -a to split command output (or quote to avoid splitting).
In tasks/5-1.sh line 103:
		convert $file "${file%.*}.jpg"
                        ^---^ SC2086: Double quote to prevent globbing and word splitting.
Did you mean: 
		convert "$file" "${file%.*}.jpg"
In tasks/5-1.sh line 112:
		       jpeg_quality_compress $2 $3
                                             ^-- SC2086: Double quote to prevent globbing and word splitting.
                                                ^-- SC2086: Double quote to prevent globbing and word splitting.
Did you mean: 
		       jpeg_quality_compress "$2" "$3"
In tasks/5-1.sh line 116:
		       keep_ratio_compress $2 $3
                                           ^-- SC2086: Double quote to prevent globbing and word splitting.
                                              ^-- SC2086: Double quote to prevent globbing and word splitting.
Did you mean: 
		       keep_ratio_compress "$2" "$3"
In tasks/5-1.sh line 120:
		       add_watermark $2 $3
                                     ^-- SC2086: Double quote to prevent globbing and word splitting.
                                        ^-- SC2086: Double quote to prevent globbing and word splitting.
Did you mean: 
		       add_watermark "$2" "$3"
In tasks/5-1.sh line 124:
		       rename_add_prefix $2 $3
                                         ^-- SC2086: Double quote to prevent globbing and word splitting.
                                            ^-- SC2086: Double quote to prevent globbing and word splitting.
Did you mean: 
		       rename_add_prefix "$2" "$3"
In tasks/5-1.sh line 128:
		       rename_add_suffix $2 $3
                                         ^-- SC2086: Double quote to prevent globbing and word splitting.
                                            ^-- SC2086: Double quote to prevent globbing and word splitting.
Did you mean: 
		       rename_add_suffix "$2" "$3"
In tasks/5-1.sh line 132:
		       transfer_format $2
                                       ^-- SC2086: Double quote to prevent globbing and word splitting.
Did you mean: 
		       transfer_format "$2"
...
after_script.2
0.14s$ /usr/bin/shellcheck tasks/5-2.sh
In tasks/5-2.sh line 25:
			total=`expr $total + 1`
                              ^---------------^ SC2006: Use $(...) notation instead of legacy backticked `...`.
                               ^--^ SC2003: expr is antiquated. Consider rewriting this using $((..)), ${} or [[ ]].
Did you mean: 
			total=$(expr $total + 1)
In tasks/5-2.sh line 26:
			if  [ $age -lt 20 ] ;then
                              ^--^ SC2086: Double quote to prevent globbing and word splitting.
Did you mean: 
			if  [ "$age" -lt 20 ] ;then
In tasks/5-2.sh line 27:
				younger_20=`expr $younger_20 + 1`
                                           ^--------------------^ SC2006: Use $(...) notation instead of legacy backticked `...`.
                                            ^--^ SC2003: expr is antiquated. Consider rewriting this using $((..)), ${} or [[ ]].
Did you mean: 
				younger_20=$(expr $younger_20 + 1)
In tasks/5-2.sh line 28:
			elif  [ $age -gt 30 ] ;then
                                ^--^ SC2086: Double quote to prevent globbing and word splitting.
Did you mean: 
			elif  [ "$age" -gt 30 ] ;then
In tasks/5-2.sh line 29:
				older_30=`expr $older_30 + 1`
                                         ^------------------^ SC2006: Use $(...) notation instead of legacy backticked `...`.
                                          ^--^ SC2003: expr is antiquated. Consider rewriting this using $((..)), ${} or [[ ]].
Did you mean: 
				older_30=$(expr $older_30 + 1)
In tasks/5-2.sh line 30:
			elif  [ $age -ge 20 ] &&  [ $age -le 30 ] ;then
                                ^--^ SC2086: Double quote to prevent globbing and word splitting.
                                                    ^--^ SC2086: Double quote to prevent globbing and word splitting.
Did you mean: 
			elif  [ "$age" -ge 20 ] &&  [ "$age" -le 30 ] ;then
In tasks/5-2.sh line 31:
				bt_20_30=`expr $bt_20_30 + 1`
                                         ^------------------^ SC2006: Use $(...) notation instead of legacy backticked `...`.
                                          ^--^ SC2003: expr is antiquated. Consider rewriting this using $((..)), ${} or [[ ]].
Did you mean: 
				bt_20_30=$(expr $bt_20_30 + 1)
In tasks/5-2.sh line 36:
...
after_script.3
0.06s$ /usr/bin/shellcheck tasks/5-3.sh
